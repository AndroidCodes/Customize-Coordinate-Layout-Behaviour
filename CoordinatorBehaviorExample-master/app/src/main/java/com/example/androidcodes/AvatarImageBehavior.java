...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_stacked_max_height) + ((int) mCustomFinalHeight / 2); //If back Button(i.e. getSupportActionBar().setDisplayHomeAsUpEnabled(true);) Of Toolbar is enable then use 48dp else use 24dp
